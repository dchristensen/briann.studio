...
Additionally, I expect students to continue lessons through the summer. During summer break, there will be 3 individual lessons and NO group classes each month. Instead of a week for group class, there will be a break each month to allow for my family vacations and/or yours. I will guarantee 9 individual lessons during the summer and pro-rate the tuition if we can't find time to schedule them. However, for those wishing for a lower financial commitment during the summer months I offer an option to split the lesson's cost with one or more additional students in a group lesson format. _Group lessons_ are different from _group classes_ and will be approved on a case by case basis.
