...
Tuition is $<span children={data.price30min} /> a 30 minute lesson or $<span children={data.price45min} />/month for a 45 minute lesson. Additional siblings receive a $<span children={data.siblingDiscount} /> discount per child.
...
Students are primarily responsible for learning the notes, fingerings and rhythms by first listening and later reading the music. I love the Suzuki method because it facilitates one-on-one time between the parent and child as the parent attends lessons and helps with daily practicing. I hope you take advantage of this quality time together!
